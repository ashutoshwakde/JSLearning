...
// let array = [12,23,34,45,"sonu","wakde"]
// console.log(array);
...
// console.log(`Element store at index 3 is - ${array[3]}`);

// console.log(`================================================================`);

// console.log(`Element store at index 0 is - ${array[0]}`);

// console.log(`================================================================`);

// let arraylength = array.length
// let lastelement = array[arraylength-1]
// console.log(`Element store at last index is - ${array[arraylength-1]}`);
...
// console.log(`is 7 available : ${array.includes(7)}`);

// console.log(`================================================================`);

// console.log(`Index of 45 is - ${array.indexOf(45)}`);
